...
const BANK_LOGOS: Record<string, { name: string; logo: string }> = {
  "bancolombia": { name: "Bancolombia", logo: "https://logo.clearbit.com/bancolombia.com.co" },
  "davivienda": { name: "Davivienda", logo: "https://logo.clearbit.com/davivienda.com" },
  "bbva": { name: "BBVA", logo: "https://logo.clearbit.com/bbva.es" },
  "bogota": { name: "Banco de Bogotá", logo: "https://logo.clearbit.com/bancodebogota.com" },
  "popular": { name: "Banco Popular", logo: "https://logo.clearbit.com/bancopopular.com.co" },
  "occidente": { name: "Banco de Occidente", logo: "https://logo.clearbit.com/bancooccidente.com.co" },
  "av villas": { name: "AV Villas", logo: "https://logo.clearbit.com/avvillas.com.co" },
  "villas": { name: "AV Villas", logo: "https://logo.clearbit.com/avvillas.com.co" },
  "caja social": { name: "Banco Caja Social", logo: "https://logo.clearbit.com/cajasocial.com.co" },
  "agrario": { name: "Banco Agrario", logo: "https://logo.clearbit.com/bancoagrario.com.co" },
  "falabella": { name: "Banco Falabella", logo: "https://logo.clearbit.com/falabella.com" },
  "itau": { name: "Itaú", logo: "https://logo.clearbit.com/itau.com.br" },
  "nequi": { name: "Nequi", logo: "https://logo.clearbit.com/nequi.com.co" },
  "nubank": { name: "Nu Bank", logo: "https://logo.clearbit.com/nubank.com.br" },
  "nu": { name: "Nu Bank", logo: "https://logo.clearbit.com/nubank.com.br" },
  "daviplata": { name: "Daviplata", logo: "https://logo.clearbit.com/daviplata.com" },
  "davibank": { name: "DaviBank", logo: "https://logo.clearbit.com/daviplata.com" },
  "serfinanza": { name: "Serfinanza", logo: "https://logo.clearbit.com/serfinanza.com.co" },
  "finandina": { name: "Finandina", logo: "https://logo.clearbit.com/finandina.com.co" },
  "bancoomeva": { name: "Bancoomeva", logo: "https://logo.clearbit.com/bancoomeva.com.co" },
  "coomeva": { name: "Bancoomeva", logo: "https://logo.clearbit.com/bancoomeva.com.co" },
};
