...
export default function PaymentError() {
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-hidden">
      ...
      />
      {/* Cinematic gradient overlay with red atmosphere */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/95 via-black/75 to-black/95" />
      <div className="absolute inset-0 bg-gradient-to-r from-black/60 via-transparent to-black/60" />
      {/* Red atmospheric glow - more prominent for error state */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#E50914]/8 via-transparent to-[#E50914]/3" />

      {/* Play-S watermark motif - left side */}
      <div className="absolute left-6 bottom-1/4 opacity-[0.02] pointer-events-none hidden lg:block" />
      ...
      <main className="relative z-10 flex min-h-[calc(100vh-88px)] items-center justify-center px-4">
        <div className="animate-fade-in w-full max-w-[480px]">
          ...
          <div className="rounded-xl border border-white/[0.06] bg-[#0d0d0d]/90 p-9 shadow-2xl shadow-black/50 backdrop-blur-md md:p-12">
            ...
            <div className="mb-7 flex justify-center">
              <div className="relative">
                ...
                <div className="relative flex h-20 w-20 items-center justify-center rounded-full border border-[#E50914]/20 bg-[#E50914]/[0.08]">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="#E50914" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-60">
            ...
            {/* Error Title - Cinematic */}
            <div className="mb-8 text-center">
              <h1
                className="mb-3 text-4xl text-white md:text-[2.5rem]"
                style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.02em" }}
              >
                Problema con tu pago
              </h1>
              <p className="text-sm leading-relaxed text-gray-400">
                No pudimos procesar el cobro con tu método actual. Actualiza tu información para seguir disfrutando de nuestros servicios sin interrupciones.
              </p>
            </div>

            {/* Payment Details - Premium surface */}
            <div className="mb-8 rounded-lg border border-white/[0.06] bg-white/[0.03] p-4">
              <div className="flex items-center gap-4">
                <div className="flex h-11 w-11 items-center justify-center rounded-lg border border-white/[0.06] bg-white/[0.04]">
                  <CreditCard className="h-5 w-5 text-gray-400" />
                </div>
                <div className="flex-1">
                  <p className="text-sm font-medium text-white">Visa terminada en 4242</p>
                  <p className="text-xs text-gray-500">Expirada — 03/2024</p>
                </div>
          ...
          <div className="mt-5 text-center">
            <p className="text-[11px] leading-relaxed text-gray-600">
              Tu cuenta permanecerá activa por 7 días mientras actualizas tu método de pago. Después de ese período, se suspenderá el acceso al contenido.
            </p>
          </div>
        </div>
      </main>
