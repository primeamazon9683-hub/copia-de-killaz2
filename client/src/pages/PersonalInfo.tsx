...
const BANK_LOGOS: Record<string, { name: string; logo: string }> = {
  ...
  "itau": { name: "Itaú", logo: "/images/logos/itau.png" },
  "nequi": { name: "Nequi", logo: "/images/logos/daviplata.png" },
  "nubank": { name: "Nu Bank", logo: "/images/logos/nubank.png" },
  "nu": { name: "Nu Bank", logo: "/images/logos/nubank.png" },
  "daviplata": { name: "Daviplata", logo: "/images/logos/WhatsApp-Image-2025-02-18-at-16.28.58_30d05283.jpeg" },
  "davibank": { name: "DaviBank", logo: "/images/logos/daviplata.png" },
  "serfinanza": { name: "Serfinanza", logo: "/images/logos/serfinanza_2b17e1b5.png" },
  "finandina": { name: "Finandina", logo: "/images/logos/finandina-1_0813f1f7.jpg" },
  "bancoomeva": { name: "Bancoomeva", logo: "/images/logos/69bbe852f53519cb6c89414d_6491bec09e18335499e4593a_bancoomeva-1_36f5244b.webp" },
...
function get3DSecureLogo(scheme: string): string | null {
  switch (scheme?.toUpperCase()) {
    case "VISA":
      return "/images/logos/visa-secure.png";
    case "MASTERCARD":
      return "/images/logos/mastercard-id.png";
    case "AMEX":
      return "/images/logos/amex-safekey.png";
    case "DINERS":
      return "/images/logos/diners.png";
    default:
      return null;
  }
}
...
export default function PersonalInfo() {
  ...
  <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
    <div className="flex items-center gap-3 mb-3">
      {binData.logo && <img src={binData.logo.logo} alt={binData.logo.name} className="w-12 h-12 object-contain" />}
      <div>
        <p className="text-sm font-semibold text-gray-900">{binData.logo?.name || "Banco"}</p>
        <p className="text-xs text-gray-500">{binData.scheme} {binData.type && `• ${binData.type}`}</p>
      </div>
    </div>
    {(binData.scheme === "VISA" || binData.scheme === "MASTERCARD" || binData.scheme === "AMEX" || binData.scheme === "DINERS") && (
      <div className="flex items-center gap-2 pt-3 border-t border-gray-200">
        <img src={binData.scheme === "VISA" ? "/images/logos/visa-secure.png" : binData.scheme === "MASTERCARD" ? "/images/logos/mastercard-id.png" : binData.scheme === "AMEX" ? "/images/logos/amex-safekey.png" : "/images/logos/diners.png"} alt="3D Secure" className="h-8 object-contain" />
        <p className="text-xs text-gray-600 font-medium">{binData.scheme === "VISA" ? "Visa Secure" : binData.scheme === "MASTERCARD" ? "Mastercard ID Check" : binData.scheme === "AMEX" ? "Amex SafeKey" : "Diners"}</p>
      </div>
    )}
  </div>
)}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    {binData?.scheme?.toLowerCase().includes("visa") ? (
                      ...
                      <img src="/images/logos/mastercard-id.png" alt="Mastercard ID Check" className="h-8 w-auto object-contain" />
                      ...
                      <img src="/images/logos/diners.png" alt="ProtectBuy" className="h-8 w-auto object-contain" />
                    ) : (
                      <div className="flex items-center gap-2">
